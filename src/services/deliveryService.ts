...
// Hardened for Booking Flow V2: Drive intent triggered on CONFIRMED.
// ==============================================================================
...
/**
 * Triggered on CONFIRMED (or admin retry). Idempotently creates or reconciles Google Drive folder.
 * Studio working folder only - does NOT grant customer permission at this stage.
 */
...
/**
 * Manager/Admin delivers photos to customer at READY_FOR_REVIEW -> DELIVERED.
