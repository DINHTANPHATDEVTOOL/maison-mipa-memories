-- ==============================================================================
-- Maison MIPA Memories - Migration: Add Admin Booking Email Alert & Ensure Studio Rooms
-- 1. Ensures studio_rooms are fully populated, valid, and active
-- 2. Hardens create_booking RPC with self-healing studio resolution
-- 3. Enqueues both customer receipt and studio admin email alert
-- ==============================================================================

-- 1. Ensure Studio Rooms are seeded and active
INSERT INTO public.studio_rooms (id, slug, code, name, description, image, capacity, active)
VALUES
  ('f0000000-0000-0000-0000-000000000001', 'room_01', 'ROOM_01', 'Tiệm Ảnh Maison MIPA — Room 01 (Atelier)', 'Không gian tiệm ảnh ấm áp, ánh sáng tự nhiên tinh tế phong cách Pháp.', '/studio.png', 6, true),
  ('f0000000-0000-0000-0000-000000000002', 'room_02', 'ROOM_02', 'Maison Room 02 (Vintage Loft)', 'Không gian gạch mộc, ánh sáng tự nhiên rực rỡ, tông nâu trầm ấm thích hợp ảnh Concept & Vintage.', 'https://images.unsplash.com/photo-1598928506311-c55ded91a20c?auto=format&fit=crop&w=800&q=80', 5, true),
  ('f0000000-0000-0000-0000-000000000003', 'garden', 'GARDEN', 'Outdoor Maison Garden', 'Khu sân vườn rợp cây xanh, cỏ lau tự nhiên & góc tiệc trà chiều lãng mạn ngoài trời.', 'https://images.unsplash.com/photo-1519741497674-611481863552?auto=format&fit=crop&w=800&q=80', 10, true)
...
BEGIN
  ...
  -- 15. Return Authoritative Domain Representation
